...
global listSel rawPlot bpfPlot spkRasts
...
spkRasts = scatter(spkAxes, rips.TimeStamps(spkX),spkY, '*k');
...
%% Callbacks/Functions
function [xData, yData] = GetVals(ts, data, windows)
xData = ts(windows(1)-50:windows(2)+50);
yData = data(windows(1)-50:windows(2)+50,:);
end
