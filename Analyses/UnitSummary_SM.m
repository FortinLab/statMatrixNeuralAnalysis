...
for t = 1:length(tetsWithUnits)
    ...
    for uni = 1:length(curUnis)
        ...
        PlotTrialEventPEH_SM(pokeInAlignedBehavMatrix, pokeOutAlignedBehavMatrix, rewardAlignedBehavMatrix, errorAlignedBehavMatrix,...
        ...
        %% Figures organized by odor
%         odorVects
        
        % PEH By Odor Poke In Perf
%         piOdr = figure;
        
        % PEH By Odor Poke Out Perf
%         poOdr = figure;
        
        % PEH By Odor Reward Perf
%         rwdOdr = figure;
        
        % PEH By Odor Error Perf
%         errOdr = figure;
