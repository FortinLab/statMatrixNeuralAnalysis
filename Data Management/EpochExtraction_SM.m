...
%                               : 'Theta' - 4:12Hz filtered in HC files,
%                                    4:8Hz in PFC files
%                               : 'Alpha' - 9:12Hz filtered in PFC files,
%                                   not present in HC files
%                               : 'LowBeta' - 13:19Hz filtered in HC files,
%                                   not present in PFC files
%                               : 'Beta' - 20:40Hz filtered in HC files,
%                                   16:32 in PFC files
%                               : 'LowGamma' - 41:59Hz filtered in HC
%                                   files, 35:55 in PFC files.
%                               : 'HighGamma' - 61:80Hz filtered
...
trialInfo = [[eventAlignedMatrix.Performance];...
    ...
    [eventAlignedMatrix.TrialNum];...
    [eventAlignedMatrix.SequenceNum];...
    [eventAlignedMatrix.PokeDuration];...
    [eventAlignedMatrix.TranspositionDistance];...
    [eventAlignedMatrix.ItemItemDistance]]';
